 ...
 * @author Francesco
 */
public class SideDirectionGeneratorTest {
   
    SideDirectionGenerator instance;
    
    public SideDirectionGeneratorTest() {
    }
    
    @Before
    public void setUp() {
        instance = new SideDirectionGenerator();
    }
    
    /**
     * Test of getDirection method, of class SideDirectionGenerator.
     */
    @Test
    public void testGetDirection() {
        System.out.println("SideDirectionGenerator - getDirection");
        Random r = new Random();
        int x = r.nextInt(100);
        int y = r.nextInt(100);
    ...
    public void testGetDirectionExc() {
        System.out.println("SideDirectionGenerator - getDirectionExc");
        Rectangle movableSpriteBounds = new Rectangle(120, 120);
